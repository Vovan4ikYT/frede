...
def open_cam_03C():
    ...
    if freddy_near_the_office is False:
        ...
        foxy_state += 1
        if foxy_state == 4:
            camera03c.after(1000, main_mshkfrede.destroy())
    else:
        jump = Toplevel()
        jump.title('СМЕРТЬ')
        jump.geometry('1920x1080')
...
def open_cam_01():
    ...
    foxy_state += 1
    if foxy_state == 4:
        camera01.after(1000, main_mshkfrede.destroy())
...
def open_cam_03B():
    ...
    if bonnie_near_the_office is False:
        ...
        foxy_state += 1
        if foxy_state == 4:
            camera03b.after(1000, main_mshkfrede.destroy())
...
def open_cam_03A():
    ...
    foxy_state += 1
    if foxy_state == 4:
        camera03a.after(1000, main_mshkfrede.destroy())
...
def open_cam_04():
    ...
    foxy_state += 1
    if foxy_state == 4:
        camera04.after(1000, main_mshkfrede.destroy())
